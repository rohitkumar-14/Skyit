export const projectSections = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        scope: "Hotel construction and development",
        status: "Completed",
        image: "assets/images/project/medium-size/2-4-370x540.jpg",
      },
      {
        id: 5,
        title: "Bliss Hotel",
        ...
        status: "Ongoing",
        image: "assets/images/project/medium-size/2-5-370x540.jpg",
      },
      {
        id: 6,
        ...
        collaboration: "Guided by Leela Palace engineering team",
        type: "Brownfield renovation project",
        status: "Completed",
        image: "assets/images/project/medium-size/2-6-370x540.jpg",
      },
      {
        id: 7,
        title: "Taj Hotels",
        type: "Interior fit-out projects",
        image: "assets/images/project/medium-size/2-7-370x540.jpg",
      },
      {
        id: 8,
        title: "Radisson Hotels",
        type: "Interior design and execution",
        image: "assets/images/project/medium-size/2-8-370x540.jpg",
      },
      {
        id: 9,
        title: "Marriott Hotels",
        type: "Hospitality interior projects",
        image: "assets/images/project/medium-size/2-9-370x540.jpg",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        size: "30-acre project",
        features:
          "Full infrastructure development and dedicated storage building",
        certification: "India's first USGBC LEED Gold Certified logistics park",
        status: "Completed",
      },
      {
        id: 11,
        ...
        type: "Logistics park development",
        status: "Completed",
      },
      {
        id: 12,
        title: "Amazon Del4",
        location: "Haryana",
        type: "Amazon fulfillment center development",
        status: "Completed",
      },
      {
        id: 13,
        ...
        size: "65-acre industrial site",
        scope:
          "Full infrastructure development and industrial factory building construction",
      ...
      },
      {
        ...
        locations: "Various parts of India",
        authority: "Ministry of Food Processing Industries (MOFPI)",
        executedBy: "Anupam Bajpai's portfolio",
        status: "Completed",
      },
      {
        id: 15,
        title: "Textile Parks",
        authority: "Ministry of Textile, Government of India",
        scope: "Complete textile park infrastructure development",
        status: "Completed",
      },
    ],
  },
    ...
    projects: [
      {
        ...
        location: "Hyderabad",
        size: "4,500 sq. meter space",
        scope: "Interior design blending functionality with modern aesthetics",
        features: "Advanced technology integration and Godrej brand identity",
      },
      {
        id: 17,
        title: "DLF Magnolias",
      ...
      },
      {
        id: 18,
        title: "WNS Offices",
        type: "Corporate interior fit-out",
      },
      {
        id: 19,
        title: "Hewitt Pan India",
        type: "Office development projects",
      },
      {
        id: 20,
        title: "Ericsson",
        type: "Corporate facility projects",
      },
      {
        id: 21,
        title: "American Express",
        type: "Office interior projects",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        type: "Government residential complex",
        authority: "Military Engineering Services",
        scope: "Complete residential colony development",
        executedBy: "Anupam Bajpai's portfolio",
        status: "Completed",
      },
      {
      ...
      },
      {
        ...
        executedBy: "Lucky Ojha's interior fit-out expertise",
      },
      {
        id: 25,
        title: "Residential, Commercial, Industrial Projects",
        executedBy:
          "Ar. Gauresh Garg's architectural portfolio spanning 15+ years",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        type: "Hospital interior fit-out and development",
        executedBy: "Lucky Ojha's healthcare sector expertise",
        status: "Completed",
      },
      {
        id: 27,
        title: "Healthcare Projects (Multiple)",
        scope: "Various healthcare facility projects",
        executedBy: "Ar. Gauresh Garg's architectural portfolio",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        type: "Entertainment complex development",
        scope: "Complete multiplex construction and finishing",
        executedBy: "Anupam Bajpai's portfolio",
        status: "Completed",
      },
    ],
    ...
    projects: [
      {
        ...
        type: "Educational facility development",
        scope: "Complete institutional building construction",
        executedBy: "Anupam Bajpai's portfolio",
        status: "Completed",
      },
    ],
    ...
    projects: [
      {
        ...
        competition: "Indore Smart City Development",
        objective: "Transform underutilized lake into vibrant community hub",
        scope:
          "Urban life meets nature, community engagement and recreation space",
      },
    ],
  },
];
export const teamMembers = [
  {
    ...
    name: "Anupam Bajpai",
    role: "Director",
    img: "/assets/images/team/medium-size/1-1-210x341.jpg",
  ...
  },
  {
    ...
    name: "Gaurav Sharma",
    role: "Director",
    img: "/assets/images/team/medium-size/1-2-210x341.jpg",
  ...
  },
  {
    ...
    role: "Architect",
    img: "/assets/images/team/medium-size/1-3-210x341.jpg",
